...
class AdminCustomersController extends AdminCustomersControllerCore
{
	public function renderForm()
	{
		...
		$obj->cc_email = Db::getInstance()->getValue('SELECT `cc_email`
		FROM '._DB_PREFIX_.'customer_cc
		WHERE id_customer = '.$obj->id);
		...
		// Instead of calling parent (AdminCustomersControllerCore) we need to call the parent of parent (AdminController)
		// If we call parent, our form will be overwritten by the default form
	}
}